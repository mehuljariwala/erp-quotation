...
import {
  Plus, Search, RefreshCw, Tag, Pencil, Trash2,
      ...
      <div className="relative bg-white rounded-xl shadow-2xl w-full max-w-md border border-slate-200">
        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-4">
          <div className="rounded-lg border border-slate-200 bg-slate-50/50 p-4">
            <h3 className="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-3">Category Details</h3>
              ...
              <div>
                ...
                {imagePreview ? (
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 h-9 px-3 text-sm text-slate-600 border border-dashed border-slate-300 rounded-lg hover:border-blue-400 hover:text-blue-600 transition-colors"
                  >
...
const DeleteConfirmModal = ({ category, onClose, onConfirm, isDeleting }) => (
  <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
    <div className="absolute inset-0 bg-slate-900/50" onClick={onClose} />
                ...
                categories.map((category, index) => (
                  <tr
                    ...
                    className={`cursor-pointer transition-colors ${
                      selectedId === category.id ? 'bg-blue-50' : 'hover:bg-slate-50'
                    }`}
                  >
                    ...
                    <td className="hidden md:table-cell px-4 py-3">
                      <span className="text-sm text-slate-600">{category.alias || '—'}</span>
                    </td>
                    <td className="px-4 py-3">
